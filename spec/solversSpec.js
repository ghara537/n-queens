describe('solvers', function() {
  ...
  describe('findNRooksSolution()', function() {
    ...
    it('finds a valid solution for n of 1-8', function() {
      ...
      console.log('findNRooks:', timer.click());
    });
    
  });

  describe('countNRooksSolutions()', function() {
    var factorialTimer = new Timer();
    it('calculates NRooks using factorial', function() {
      _.range(1, 9).map(function(n) {
        var solutionCount = factorial(n);
        var expectedSolutionCount = [1, 1, 2, 6, 24, 120, 720, 5040, 40320][n];
        expect(solutionCount).to.be.equal(expectedSolutionCount);
      }); 
      console.log('factorial timer:',factorialTimer.click());
    });
    it('works, I promise', function() {});
    it('finds the number of valid solutions for n of 1-8', function() {
      ...
      console.log('countNRooks:', timer.click());
    });
  ...
  describe('findNQueensSolution()', function() {
    ...
    it('finds a valid solution for n of 0-7', function() {
      ...
      console.log('findNQueens:', timer.click());
    });
  ...
  describe('countNQueensSolutions()', function() {
    ...
    it('finds the number of valid solutions for n of 0-8', function() {
      ...
      console.log('countNQueens:',timer.click());
    });
